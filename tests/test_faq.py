...
class TestFAQ:
    ...
    def test_faq_questions_cost_question(self, driver):
    ...
    def test_faq_questions_few_object_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
    ...
    def test_faq_questions_time_rent_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
    ...
    def test_faq_questions_today_order_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
    ...
    def test_faq_questions_extension_or_refund_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
    ...
    def test_faq_questions_charger_with_order_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
    ...
    def test_faq_questions_cansel_order_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
    ...
    def test_faq_questions_area_of_order_question(self, driver):
        home_page = HomePage(driver)
        home_page.open()
